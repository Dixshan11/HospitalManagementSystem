...
namespace assigenment_hospital {
    ...
    public partial class hospitalDataSet1 : global::System.Data.DataSet {
        ...
        public partial class DOCTORDataTable : global::System.Data.TypedTableBase<DOCTORRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DOCTORRow AddDOCTORRow(string f_name) {
...
namespace assigenment_hospital.hospitalDataSet1TableAdapters {
    ...
    public partial class DOCTORTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[DOCTOR] WHERE (([d_id] = @Original_d_id) AND ((@IsNull_f_name " +
                "= 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DOCTOR] ([f_name]) VALUES (@f_name);\r\nSELECT d_id, f_name FROM" +
                " DOCTOR WHERE (d_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[DOCTOR] SET [f_name] = @f_name WHERE (([d_id] = @Original_d_id) AND" +
                " ((@IsNull_f_name = 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)));\r" +
                "\nSELECT d_id, f_name FROM DOCTOR WHERE (d_id = @d_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT d_id, f_name FROM dbo.DOCTOR";
        ...
        public virtual int Delete(int Original_d_id, string Original_f_name) {
        ...
        public virtual int Update(string f_name, int Original_d_id, string Original_f_name, int d_id) {
            if ((f_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string f_name, int Original_d_id, string Original_f_name) {
            return this.Update(f_name, Original_d_id, Original_f_name, Original_d_id);
        }
    }
