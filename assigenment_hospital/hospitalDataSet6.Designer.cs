...
namespace assigenment_hospital {
    ...
    public partial class hospitalDataSet6 : global::System.Data.DataSet {
        ...
        public partial class NURSEDataTable : global::System.Data.TypedTableBase<NURSERow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NURSERow AddNURSERow(string f_name, string l_name, string gender, string telephone_no, string nic, string address, string email) {
        ...
        public partial class NURSERow : global::System.Data.DataRow {
            ...
            public string telephone_no {
                get {
                    try {
                        return ((string)(this[this.tableNURSE.telephone_noColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace assigenment_hospital.hospitalDataSet6TableAdapters {
    ...
    public partial class NURSETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NURSE] ([f_name], [l_name], [gender], [telephone_no], [nic], [address], [email]) VALUES (@f_name, @l_name, @gender, @telephone_no, @nic, @address, @email);
SELECT n_id, f_name, l_name, gender, telephone_no, nic, address, email FROM NURSE WHERE (n_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NURSE] SET [f_name] = @f_name, [l_name] = @l_name, [gender] = @gender, [telephone_no] = @telephone_no, [nic] = @nic, [address] = @address, [email] = @email WHERE (([n_id] = @Original_n_id) AND ((@IsNull_f_name = 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)) AND ((@IsNull_l_name = 1 AND [l_name] IS NULL) OR ([l_name] = @Original_l_name)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_telephone_no = 1 AND [telephone_no] IS NULL) OR ([telephone_no] = @Original_telephone_no)) AND ((@IsNull_nic = 1 AND [nic] IS NULL) OR ([nic] = @Original_nic)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT n_id, f_name, l_name, gender, telephone_no, nic, address, email FROM NURSE WHERE (n_id = @n_id)";
        ...
        public virtual int Fill(hospitalDataSet6.NURSEDataTable dataTable) {
        ...
        public virtual hospitalDataSet6.NURSEDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet6.NURSEDataTable dataTable = new hospitalDataSet6.NURSEDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet6.NURSEDataTable dataTable) {
        ...
        public virtual int Delete(int Original_n_id, string Original_f_name, string Original_l_name, string Original_gender, string Original_telephone_no, string Original_nic, string Original_address, string Original_email) {
            ...
            if ((Original_telephone_no == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_telephone_no));
            }
        ...
        public virtual int Insert(string f_name, string l_name, string gender, string telephone_no, string nic, string address, string email) {
            if ((f_name == null)) {
            ...
            if ((telephone_no == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(telephone_no));
            }
            if ((nic == null)) {
        ...
        public virtual int Update(
            ...
            if ((telephone_no == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(telephone_no));
            }
            if ((nic == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_n_id));
            if ((Original_f_name == null)) {
            ...
            if ((Original_telephone_no == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_telephone_no));
            }
            if ((Original_nic == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[22].Value = ((int)(n_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string f_name, string l_name, string gender, string telephone_no, string nic, string address, string email, int Original_n_id, string Original_f_name, string Original_l_name, string Original_gender, string Original_telephone_no, string Original_nic, string Original_address, string Original_email) {
            return this.Update(f_name, l_name, gender, telephone_no, nic, address, email, Original_n_id, Original_f_name, Original_l_name, Original_gender, Original_telephone_no, Original_nic, Original_address, Original_email, Original_n_id);
        }
    }
