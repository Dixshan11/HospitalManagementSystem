...
namespace assigenment_hospital {
    ...
    public partial class hospitalDataSet14 : global::System.Data.DataSet {
        ...
        public partial class PATIENTDataTable : global::System.Data.TypedTableBase<PATIENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PATIENTRow AddPATIENTRow(string f_name, string l_name, string dob, string gender, string telephoneno, string address, string email, string nic) {
...
namespace assigenment_hospital.hospitalDataSet14TableAdapters {
    ...
    public partial class PATIENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[PATIENT] ([f_name], [l_name], [dob], [gender], [telephoneno], [address], [email], [nic]) VALUES (@f_name, @l_name, @dob, @gender, @telephoneno, @address, @email, @nic);
SELECT p_id, f_name, l_name, dob, gender, telephoneno, address, email, nic FROM PATIENT WHERE (p_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PATIENT] SET [f_name] = @f_name, [l_name] = @l_name, [dob] = @dob, [gender] = @gender, [telephoneno] = @telephoneno, [address] = @address, [email] = @email, [nic] = @nic WHERE (([p_id] = @Original_p_id) AND ((@IsNull_f_name = 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)) AND ((@IsNull_l_name = 1 AND [l_name] IS NULL) OR ([l_name] = @Original_l_name)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_telephoneno = 1 AND [telephoneno] IS NULL) OR ([telephoneno] = @Original_telephoneno)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_nic = 1 AND [nic] IS NULL) OR ([nic] = @Original_nic)));
SELECT p_id, f_name, l_name, dob, gender, telephoneno, address, email, nic FROM PATIENT WHERE (p_id = @p_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT p_id, f_name, l_name, dob, gender, telephoneno, address, email, nic FROM d" +
                "bo.PATIENT";
        ...
        public virtual int Fill(hospitalDataSet14.PATIENTDataTable dataTable) {
        ...
        public virtual hospitalDataSet14.PATIENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet14.PATIENTDataTable dataTable = new hospitalDataSet14.PATIENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet14.PATIENTDataTable dataTable) {
        ...
        public virtual int Delete(int Original_p_id, string Original_f_name, string Original_l_name, string Original_dob, string Original_gender, string Original_telephoneno, string Original_address, string Original_email, string Original_nic) {
        ...
        public virtual int Insert(string f_name, string l_name, string dob, string gender, string telephoneno, string address, string email, string nic) {
            if ((f_name == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(p_id));
        ...
        public virtual int Update(
                    ...
                    string Original_email, 
                    string Original_nic) {
            return this.Update(f_name, l_name, dob, gender, telephoneno, address, email, nic, Original_p_id, Original_f_name, Original_l_name, Original_dob, Original_gender, Original_telephoneno, Original_address, Original_email, Original_nic, Original_p_id);
        }
    }
