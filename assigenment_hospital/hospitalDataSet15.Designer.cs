...
namespace assigenment_hospital.hospitalDataSet15TableAdapters {
...
SELECT p_id, f_name, l_name, dob, gender, telephoneno, address, email, nic FROM PATIENT WHERE (p_id = @p_id)";
        ...
        public virtual int Fill(hospitalDataSet15.PATIENTDataTable dataTable) {
        ...
        public virtual hospitalDataSet15.PATIENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet15.PATIENTDataTable dataTable = new hospitalDataSet15.PATIENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet15.PATIENTDataTable dataTable) {
