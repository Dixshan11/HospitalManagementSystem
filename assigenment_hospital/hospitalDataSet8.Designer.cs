...
namespace assigenment_hospital.hospitalDataSet8TableAdapters {
...
SELECT n_id, f_name, l_name, gender, telephone_no, nic, address, email FROM NURSE WHERE (n_id = @n_id)";
        ...
        public virtual int Fill(hospitalDataSet8.NURSEDataTable dataTable) {
        ...
        public virtual hospitalDataSet8.NURSEDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet8.NURSEDataTable dataTable = new hospitalDataSet8.NURSEDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet8.NURSEDataTable dataTable) {
