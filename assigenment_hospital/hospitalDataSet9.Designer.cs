...
namespace assigenment_hospital.hospitalDataSet9TableAdapters {
...
SELECT n_id, f_name, l_name, gender, telephone_no, nic, address, email FROM NURSE WHERE (n_id = @n_id)";
        ...
        public virtual int Fill(hospitalDataSet9.NURSEDataTable dataTable) {
        ...
        public virtual hospitalDataSet9.NURSEDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet9.NURSEDataTable dataTable = new hospitalDataSet9.NURSEDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet9.NURSEDataTable dataTable) {
