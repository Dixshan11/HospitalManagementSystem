...
namespace assigenment_hospital.hospitalDataSet16TableAdapters {
...
SELECT p_id, f_name, l_name, dob, gender, telephoneno, address, email, nic FROM PATIENT WHERE (p_id = @p_id)";
        ...
        public virtual int Fill(hospitalDataSet16.PATIENTDataTable dataTable) {
        ...
        public virtual hospitalDataSet16.PATIENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hospitalDataSet16.PATIENTDataTable dataTable = new hospitalDataSet16.PATIENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hospitalDataSet16.PATIENTDataTable dataTable) {
